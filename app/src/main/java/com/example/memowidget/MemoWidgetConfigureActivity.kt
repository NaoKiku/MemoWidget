...
class MemoWidgetConfigureActivity : Activity() {
    ...
    /* WidgetTextの初期化はonCreate()で行うため，
       後から初期化をすることを，明示的に示す必要があるのです．*/
    private lateinit var appWidgetText: EditText
    private var onClickListener = View.OnClickListener {
        val context = this@MemoWidgetConfigureActivity
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        appWidgetText.setText(loadTitlePref(this@MemoWidgetConfigureActivity, appWidgetId))
    }

}

private const val PREFS_NAME = "com.example.memowidget.MemoWidget"
